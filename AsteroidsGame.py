...
def redrawGameWindow():
    ...
    text_lives = font.render("LIVES: ", + int(lives), 1, (255,255,255))
    text_score = font.render("SCORE: ", + int(score), 1, (255,255,255))
    text_retry = font.render("PRESS SPACE TO RETRY", 1, (255,255,255))
    player.draw(window)
